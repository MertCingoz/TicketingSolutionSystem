var isDrawingContinue=false;

var Areas = function(canvasId){
...
Areas.prototype.getContext = function(){
    return this.context;
};

Areas.prototype.getCanvas = function(){
    return this.canvas;
};
...
Areas.prototype.getCanvasPos = function(){
...
Areas.prototype.setStage = function(func){
    this.stage = func;
    this.listen();
};
...
Areas.prototype.reset = function(evt){
    if (!evt) {
        evt = window.event;
    }
...
Areas.prototype.listen = function(){
    var that = this;
    ...
    this.canvas.addEventListener("mousemove", function(evt){
    	if(!isDrawingContinue){
    		$("#mesaj1").html("icerde"+isDrawingContinue);
    		that.reset(evt);
    	}
    }, false);
...
Areas.prototype.getMousePos = function(evt){
    return this.mousePos;
};

Areas.prototype.getTouchPos = function(evt){
    return this.touchPos;
};

Areas.prototype.setMousePosition = function(evt){
...
Areas.prototype.setTouchPosition = function(evt){
...
Areas.prototype.beginRegion = function(){
    this.currentRegion = {};
    this.regionIndex++;
    
};

Areas.prototype.addRegionEventListener = function(type, func){
    var event = (type.indexOf('touch') == -1) ? 'on' + type : type;
    this.currentRegion[event] = func;
    
};

Areas.prototype.closeRegion = function(){
